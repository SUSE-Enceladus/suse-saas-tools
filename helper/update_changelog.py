#!/usr/bin/python3
"""
usage: update_changelog --from=<start> (--since=<reference_file>|--file=<reference_file>)
            [--utc]
            [--fix]

arguments:
    --from=<start>
        changes for this file or directory entrypoint only
...
if arguments['--since']:
    ...
    process = subprocess.Popen(
        [
            ...
            '--since="{0}"'.format(latest_date), from_start
